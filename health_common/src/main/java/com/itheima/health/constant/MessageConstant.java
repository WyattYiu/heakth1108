...
// ------------------------角色-----------------------------------------
    ...
    // ------------------------用户-----------------------------------------
    public static final String ADD_USER_SUCCESS = "新增角色成功";
    public static final String ADD_USER_FAIL = "新增角色失败";

    public static final String QUERY_USER_SUCCESS = "查询角色成功";
    public static final String QUERY_USER_FAIL = "查询角色失败";

    public static final String EDIT_USER_SUCCESS = "编辑角色成功";
    public static final String EDIT_USER_FAIL = "编辑角色失败";
